              ...
              <div key={index} className="">
                ...
                <div>
                  <p className="text-sm text-gray-600 pb-4">
                    Toggling on emergency mode would enable others access your
                    medical summary using your Health Identification Number
                    (HIN) through the guest mode. Always keep your HIN safe.
                  </p>
                </div>
                <div
