...
const UserDashboardRecords = ({loading, records, totalPages , currentPage, setCurrentPage, togglePopover, popoverVisible, datainfo, selectedRecord, exportToPDF, setPopoverVisible}) => {
  return (
