    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 ">
      <div className="bg-white  max-w-96 relative w-full p-5 mx-3">
          ...
          <div className="bg-white ">
            <div className="mb-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md text-gray-500 focus:outline-hidden focus:ring-2 focus:ring-docuhealth-blue  text-sm"
              />
            </div>
            ...
            <div className="mb-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md focus:outline-hidden focus:ring-2 focus:ring-docuhealth-blue  text-sm"
              />
            </div>
            ...
            <div className="mb-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border rounded-md focus:outline-hidden focus:ring-2 focus:ring-docuhealth-blue  h-24 resize-none text-sm"
              ></textarea>
            </div>
              ...
              <Link
                to="/privacy-policy"
                className="text-docuhealth-blue hover:underline"
              >
                Privacy Policy
              </Link>
              .
        ...
        <button
          ...
          className="mt-4 w-full bg-docuhealth-blue text-white py-2 rounded-full transition text-sm"
        >
