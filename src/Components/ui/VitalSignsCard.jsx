...
const VitalSignsCard = ({ vitalSigns, title = "Vital Signs", className = "p-5 my-5 bg-docuhealth-light-gray border rounded-xl" }) => {
  if (!vitalSigns) return null;

  return (
    <div className={className}>
      {title && <p className="font-medium mb-4">{title}</p>}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-[12px]">
        ...
        <div className=" bg-white border rounded-md p-3">
          ...
          <p className="font-medium">
            {vitalSigns?.blood_pressure || "NIL"} mmHg
          </p>
        </div>
        {/* Temperature */}
        <div className=" bg-white border rounded-md p-3">
        ...
        <div className=" bg-white border rounded-md p-3">
          ...
          <p className="font-medium">{vitalSigns?.bmi ? `${vitalSigns.bmi} Kg/m²` : "NIL"}</p>
        </div>
        {/* Pain score */}
        <div className=" bg-white border rounded-md p-3">
          <p className="text-[12px] text-gray-400 flex items-center gap-1 pb-2">
          ...
          <p className="font-medium">{vitalSigns?.pain_score || "NIL"}</p>
        </div>
        {/* SpO2 */}
        <div className=" bg-white border rounded-md p-3">
          <p className="text-[12px] text-gray-400 flex items-center gap-1 pb-2">
