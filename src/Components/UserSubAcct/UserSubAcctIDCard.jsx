...
const UserSubAcctIDCard = ({generateIDCard, setGenerateIDCard, selectedUser, formData, handleChange, handleIDCreation, loadingCard, downloadIDCard, TIDF, TIDB, generateIDCardForm, logo, NL, selectedUserHIN, selectedUserDOB }) => {
    return (
        <div className="">
              {generateIDCardForm && (
...
export default UserSubAcctIDCard;