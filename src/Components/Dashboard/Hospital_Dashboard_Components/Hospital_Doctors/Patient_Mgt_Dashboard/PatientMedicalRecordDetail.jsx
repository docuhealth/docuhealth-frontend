          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            ...
            <div className="">
              <p className="text-[12px]">
                ...
                <span className="font-medium ">
                  {" "}
                  {selectedMedicalRecord?.staff_info?.firstname || selectedMedicalRecord?.doctor_info?.firstname}{" "}
                  {selectedMedicalRecord?.staff_info?.lastname || selectedMedicalRecord?.doctor_info?.lastname}
                </span>
              </p>
              <p className="text-[12px]">
                {" "}
                ...
                <span className="font-medium">
                  {" "}
                  {selectedMedicalRecord?.staff_info?.specialization || selectedMedicalRecord?.doctor_info?.specialization ||
                    "surgeon"}
                </span>
              </p>
            </div>
