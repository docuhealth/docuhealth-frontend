                                ...
                                <div className="mb-4">
                                    <label className="flex items-center cursor-pointer group">
                                        <div className="relative">
                                            ...
                                            />
                                            <div className={`block w-8 h-4 rounded-full transition ${useTodayDate ? 'bg-docuhealth-primary' : 'bg-gray-300'} ${(!isToday && !useTodayDate) ? 'opacity-50 cursor-not-allowed' : ''}`}></div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[12px]">
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className={`w-full border border-gray-300 rounded-lg px-2 py-2 focus:outline-hidden focus:border-docuhealth-primary appearance-none cursor-pointer text-[12px] ${useTodayDate ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                                        >
                                            {[...Array(31)].map((_, i) => (
                                        ...
                                        <div key={index} className="border rounded-md p-3">
                                            <div>
                                                ...
                                                <div className="w-full pt-8">
                                                    <button className="w-full rounded-full border py-2 border-docuhealth-primary text-docuhealth-primary cursor-pointer"
