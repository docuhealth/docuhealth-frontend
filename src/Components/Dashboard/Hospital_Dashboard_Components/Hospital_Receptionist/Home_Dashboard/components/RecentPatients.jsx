...
import { ReceptionistRecentPatientsContext } from '../../../../../../context/HospitalContext/Receptionist/ReceptionistRecentPatientsContext'
...
const RecentPatients = () => {
    ...
    if (recentPatients.length === 0 && !searchQuery) {
        return (
                    ...
                    sortedPatients.map((patient, index) => (
                        <div key={index} className='relative'>
                            <div className="grid grid-cols-7 items-center text-[12px] text-gray-700 text-left w-full  border-b border-b-gray-200">
                                ...
                                <p>
                                    {(patient?.patient_info?.hin || patient?.patient?.hin)
                                        ? (patient?.patient_info?.hin || patient?.patient?.hin).slice(0, 4) + "••••••" + (patient?.patient_info?.hin || patient?.patient?.hin).slice(-2)
                                        : ""}
                                </p>
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="bg-gray-50 text-gray-600 text-[10px] px-2 py-1 rounded-md border border-gray-100 font-medium uppercase tracking-wider">
                                {(patient?.patient_info?.hin || patient?.patient?.hin)?.slice(-4) || "N/A"}
                            </span>
                        </div>
