                    ...
                    sortedPatients.map((admittedPatient, index) => (
                        <div key={index} className="border p-4 rounded-lg">
                            <div className='flex justify-between items-center'>
                                <p>{admittedPatient?.patient_info?.firstname} {admittedPatient?.patient_info?.lastname} </p>
                                <div className="bg-docuhealth-light-green px-2 rounded-full">
                                    <p className="text-docuhealth-green ">{formatRecordDate(admittedPatient.discharge_date) || 'NIL'}</p>
                                </div>
                            </div>
                            <div className='border-b py-2'>
                                <p className='text-gray-600'>HIN : {(admittedPatient?.patient_info?.hin || admittedPatient?.patient?.hin) ? admittedPatient.patient_info.hin.slice(0, 4) + "••••••" + admittedPatient.patient_info.hin.slice(-2) : 'N/A'}</p>
...
const tabs = [
    { title: "Admitted Patients", status: "active", content: <AdmittedPatientsTab /> },
    { title: "Discharged Patients", status: "discharged", content: <DischargedPatientsTab /> },
]
