...
const Hospital_Receptionist_Sidebar_Mobile = ({
  openMobileSidebar,
  ...
  const { hospitalLogo, hospitalName } = useContext(ReceptionistAppContext);
          ...
          <ul>
            <Link to="/hospital-receptionist-home-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-receptionist-home-dashboard"
                ...
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-home-dashboard"
                        ? "fill-white"
                        : ""
                        }`}
                    >
            ...
            <Link to="/hospital-receptionist-admission-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-receptionist-admission-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-admission-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-receptionist-patients-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-receptionist-patients-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-patients-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
                ...
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-messages-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-receptionist-healthpersonnel-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-receptionist-healthpersonnel-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-healthpersonnel-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-receptionist-appointments-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-receptionist-appointments-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-receptionist-appointments-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
...
export default Hospital_Receptionist_Sidebar_Mobile