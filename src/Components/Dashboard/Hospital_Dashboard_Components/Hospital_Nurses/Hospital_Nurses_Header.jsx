...
const Hospital_Nurses_Header = () => {
  ...
  const handleFinalRequest = async (staff_id) => {
    ...
    const {
      patientManagement: handover_appointments_state,
      myAppointments: handover_patients_state,
    } = handoverData;
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Handover failed. Please try again.",
      );
    } finally {
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
              ...
              {hospitalLogo ? (
                ...
                <div className="w-10 h-10 rounded-full bg-linear-to-tr from-docuhealth-primary to-indigo-400 flex justify-center items-center text-white text-sm font-bold shadow-md">
                  {initials}
                </div>
              )}
            </div>
            ...
            <div className="relative">
              ...
              >
                {hospitalLogo ? (
                  ...
                  <div className="w-9 h-9 rounded-full bg-linear-to-tr from-docuhealth-primary to-indigo-400  flex items-center justify-center text-white text-xs font-bold ring-2 ring-indigo-50">
                    {initials}
                  </div>
                )}
                <ChevronDown
              ...
              {isPopoverOpen && (
                <div className="absolute right-0 top-14 w-48 bg-white border border-gray-100 shadow rounded-lg p-2 animate-in fade-in zoom-in duration-200">
                  <div className="px-3 py-2 mb-1 border-b border-gray-50">
                    ...
                    <p className="text-[10px] text-gray-500">Nurse</p>
                  </div>
