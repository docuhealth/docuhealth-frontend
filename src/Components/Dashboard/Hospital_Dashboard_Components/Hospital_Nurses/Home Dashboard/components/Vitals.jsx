...
const Vitals = ({ setVitals, setSelectedPatient }) => {
    ...
    const fetchAssignedForVitals = async (page = 1) => {
        ...
        try {
            ...
            console.log('vitals requests', res.data)
    ...
    return (
        <>
            <div className='bg-white rounded-xl border mt-3 p-5 text-sm'>
                        ...
                        assignedVitals.map((vital, index) => (
                            <div key={index} className="border p-3 rounded-xl">
                                <div className='flex justify-between items-center'>
                                    <p className='font-medium'>{vital.patient.firstname} {vital.patient.lastname} </p>
                                ...
                                <div className='pt-1 pb-3 border-b'>
                                    <p className='text-gray-600'>Status : <span className="text-amber-600">{vital.status}</span></p>
                                </div>
                                {/* <div className='flex items-center gap-1 text-gray-600 border-b py-3'>
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className='text-gray-600'>Note : {vital.note || 'NIL'}</p>
                                </div> */}
                ...
                fetchData={fetchAssignedForVitals}
                />
