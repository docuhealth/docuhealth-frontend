...
const Hospital_Nurses_Sidebar_Mobile = ({
  openMobileSidebar,
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div
        className={`w-64 fixed top-0 bottom-0 left-0 h-full z-50 bg-white transform transition-transform duration-300 ease-in-out flex flex-col justify-between
      ...
      >
        ...
        <div>
          ...
          <nav className="mt-4 text-sm">
            <ul>
              {/* Overview */}
              <Link to="/hospital-nurses-home-dashboard" onClick={() => setOpenMobileSidebar(false)}>
                  ...
                  <li
                    className={`group px-4 py-2 ${
                      currentPath === "/hospital-nurses-home-dashboard"
                        ...
                        : "text-gray-700"
                    } hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                  >
                    <span>
                      <svg
                        width="20"
                      ...
                      >
                        <path
                          ...
                          className={`group-hover:fill-white ${
                            currentPath === "/hospital-nurses-home-dashboard" ? "fill-white" : "fill-[#647284]"
                          }`}
                        />
                      </svg>
                    </span>
              ...
              {/* Patient Management */}
              <Link to="/hospital-nurses-patients-dashboard" onClick={() => setOpenMobileSidebar(false)}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2 ${
                  ...
                  >
                    <span>
                      ...
                      >
                        <path
                          d="M12.5 3.33268H4.16667V16.666H15.8333V6.66602H12.5V3.33268ZM2.5 2.49252C2.5 2.03606 2.8731 1.66602 3.33208 1.66602H13.3333L17.4998 5.83268L17.5 17.4931C17.5 17.9568 17.1292 18.3327 16.6722 18.3327H3.32783C2.87063 18.3327 2.5 17.9533 2.5 17.5062V2.49252ZM10 9.58268C8.84942 9.58268 7.91667 8.64993 7.91667 7.49935C7.91667 6.34876 8.84942 5.41602 10 5.41602C11.1506 5.41602 12.0833 6.34876 12.0833 7.49935C12.0833 8.64993 11.1506 9.58268 10 9.58268ZM6.27288 14.166C6.48016 12.291 8.06977 10.8327 10 10.8327C11.9303 10.8327 13.5198 12.291 13.7271 14.166H6.27288Z"
                          className={`group-hover:fill-white ${
                            currentPath === "/hospital-nurses-patients-dashboard" ? "fill-white" : "fill-[#647284]"
                          }`}
                        />
                      </svg>
                    </span>
              ...
              {/* Health Personnel */}
              <Link to="/hospital-nurses-healthpersonnel-dashboard" onClick={() => setOpenMobileSidebar(false)}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2 ${
                    ...
                    <span>
                      ...
                      >
                        <path
                          ...
                          className={`group-hover:fill-white ${
                            currentPath === "/hospital-nurses-healthpersonnel-dashboard" ? "fill-white" : "fill-[#647284]"
                          }`}
                        />
                      </svg>
                    </span>
              ...
              {/* Appointments */}
              <Link to="/hospital-nurses-appointments-dashboard" onClick={() => setOpenMobileSidebar(false)}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2 ${
                    ...
                    <span>
                      ...
                      >
                        <path
                          ...
                          className={`group-hover:fill-white ${
                            currentPath === "/hospital-nurses-appointments-dashboard" ? "fill-white" : "fill-[#647284]"
                          }`}
                        />
                      </svg>
                    </span>
        ...
        {/* Bottom Section: Settings & Logout aligned down */}
        <div className="text-sm mb-4">
          <ul>
            {/* Settings */}
            <Link to="/hospital-nurses-settings-dashboard" onClick={() => setOpenMobileSidebar(false)}>
...
export default Hospital_Nurses_Sidebar_Mobile;