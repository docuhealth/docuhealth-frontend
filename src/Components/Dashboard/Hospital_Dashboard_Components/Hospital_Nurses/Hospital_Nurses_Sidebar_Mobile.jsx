        ...
        <nav className="mt-4 text-sm">
          ...
          <Link to="/hospital-nurses-home-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-home-dashboard"
                ...
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-home-dashboard"
                          ? "fill-white"
                          : ""
                        }`}
                    >
            ...
            <Link to="/hospital-nurses-patients-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-patients-dashboard"
                      ? "bg-[#3E4095] text-white"
                      : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-patients-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-nurses-messages-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-messages-dashboard"
                      ? "bg-[#3E4095] text-white"
                      : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-messages-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-nurses-healthpersonnel-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-healthpersonnel-dashboard"
                      ? "bg-[#3E4095] text-white"
                      : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-healthpersonnel-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-nurses-appointments-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-appointments-dashboard"
                      ? "bg-[#3E4095] text-white"
                      : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-appointments-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
                      <path
                        ...
                        className={`group-hover:fill-white ${currentPath ===
                            "/hospital-nurses-appointments-dashboard"
                            ? "fill-white"
                            : "fill-[#647284]"
                          }`}
                      />
            ...
            <Link to="/hospital-nurses-settings-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-nurses-settings-dashboard"
                      ? "bg-[#3E4095] text-white"
                      : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-nurses-settings-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
