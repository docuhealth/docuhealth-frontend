...
const Hospital_Pharmacist_Sidebar_Mobile = ({
  openMobileSidebar,
    ...
    <>
      ...
      >
       <div className="p-4 flex justify-between items-center    ">
        ...
        <ul>
          {/* Overview */}
          <Link to="/hospital-pharmacist-home-dashboard" onClick={() => setOpenMobileSidebar(false)}>
          ...
          <Link to="/hospital-pharmacist-prescriptions-dashboard" onClick={() => setOpenMobileSidebar(false)}>
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
          ...
          <Link to="/hospital-pharmacist-appointments-dashboard" onClick={() => setOpenMobileSidebar(false)}>
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
          ...
          <Link to="/hospital-pharmacist-healthpersonnel-dashboard" onClick={() => setOpenMobileSidebar(false)}>
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
      ...
      <div className="text-sm border-t border-gray-100 pb-4 pt-2 shrink-0">
        <ul>
          <Link to="/hospital-pharmacist-settings-dashboard" onClick={() => setOpenMobileSidebar(false)}>
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
...
export default Hospital_Pharmacist_Sidebar_Mobile;
