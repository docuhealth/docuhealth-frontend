  ...
  return (
    <div className="mb-4 p-4 border rounded-md flex flex-wrap items-center gap-4 lg:gap-8">
      ...
      <div className="flex items-center gap-3 min-w-[140px]">
        ...
        <div className="min-w-0">
          <p className="text-[10px] text-gray-500 uppercase font-semibold">Appointed Doctor</p>
          <p className="text-sm font-medium truncate">{getDoctorName(appt)}</p>
        </div>
      </div>
...
export default PharmacistAppointmentRow;
