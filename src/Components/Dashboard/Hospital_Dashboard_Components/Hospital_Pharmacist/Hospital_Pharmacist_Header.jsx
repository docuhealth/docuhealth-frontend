...
import Hospital_Pharmacist_Sidebar_Mobile from "./Hospital_Pharmacist_Sidebar_Mobile";
import { PharmacistAppContext } from "../../../../context/HospitalContext/Pharmacist/PharmacistAppContext";

const Hospital_Pharmacist_Header = () => {
  const [isPopoverOpen, setIsPopoverOpen] = useState(false);
  const [openMobileSidebar, setOpenMobileSidebar] = useState(false);
  
  const { profile, hospitalLogo } = useContext(PharmacistAppContext);
  ...
  return (
    <>
      ...
      <Hospital_Pharmacist_Sidebar_Mobile
...
export default Hospital_Pharmacist_Header;
