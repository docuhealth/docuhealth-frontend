...
import Hospital_Lab_Sidebar_Mobile from "./Hospital_Lab_Sidebar_Mobile";
import { LabAppContext } from "../../../../context/HospitalContext/Lab/LabAppContext";

const Hospital_Lab_Header = () => {
              ...
              {isPopoverOpen && (
                <div className="absolute right-0 top-14 w-48 bg-white border border-gray-100 shadow rounded-lg p-2 animate-in fade-in zoom-in duration-200">
                  <div className="px-3 py-2 mb-1 border-b border-gray-50">
                    ...
                    <p className="text-[10px] text-gray-500">Lab Scientist</p>
                  </div>
                  <button
...
export default Hospital_Lab_Header;
