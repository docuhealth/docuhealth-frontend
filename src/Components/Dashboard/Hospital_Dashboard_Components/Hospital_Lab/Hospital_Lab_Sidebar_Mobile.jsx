          ...
          <ul>
            ...
            <Link to="/hospital-lab-settings-dashboard" onClick={() => setOpenMobileSidebar(false)}>
              <div className="px-4 my-2">
                <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-settings-dashboard" ? "bg-[#3E4095] text-white" : "text-gray-700"} text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                  <span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
