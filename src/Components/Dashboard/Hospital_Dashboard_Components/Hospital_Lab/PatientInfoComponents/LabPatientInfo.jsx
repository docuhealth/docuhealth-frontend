                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 text-[12px] w-full sm:w-auto">
                          ...
                          <div className=" flex items-center justify-center gap-1 border border-blue-600 bg-docuhealth-primary text-white  rounded-full font-medium hover:bg-docuhealth-dark-primary transition  text-center py-1 px-3 w-full sm:w-28">
