    ...
    <div className="flex flex-col h-screen">
      ...
      <nav className="flex-1  text-sm overflow-y-auto">
        <ul>
          ...
          {/* Results */}
          <Link to="/hospital-lab-results-dashboard">
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-results-dashboard" ? "bg-[#3E4095] text-white" : "text-gray-700"} hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
