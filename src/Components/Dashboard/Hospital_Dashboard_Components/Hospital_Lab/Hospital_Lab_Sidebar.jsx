...
const Hospital_Lab_Sidebar = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Logo */}
      <div className="pt-5 pl-5 pb-3 flex items-center gap-1 font-semibold text-docuhealth-primary shrink-0">
        ...
        <ul>
          ...
          <Link to="/hospital-lab-home-dashboard">
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-home-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
          ...
          <Link to="/hospital-lab-requests-dashboard">
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${TEST_ORDERS_ROUTES.includes(currentPath) ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to="/hospital-lab-appointments-dashboard">
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${["/hospital-lab-appointments-dashboard", "/hospital-lab-appointment-detail"].includes(currentPath) ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="cursor-pointer" onClick={() => toast.success("Coming Soon !")}>
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-messages-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to="/hospital-lab-healthpersonnel-dashboard">
            <div className="px-4 my-4">
              <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-healthpersonnel-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul>
          ...
          <Link to="/hospital-lab-settings-dashboard">
            <div className="px-4 my-2">
              <li className={`group px-4 py-2 ${currentPath === "/hospital-lab-settings-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}>
                <span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default Hospital_Lab_Sidebar;
