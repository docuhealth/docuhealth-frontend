...
const DischargedPatientsChart = ({ data = [], filter = "Monthly", onFilterChange }) => {
  ...
  const handleDownload = () => {
    ...
    link.setAttribute("download", `discharged_patients_${filter}.csv`);
    ...
    return (
      <div className="bg-white p-6 rounded-md border border-gray-200 w-full h-[380px] flex flex-col">
        ...
        <div className="flex-1 flex justify-center items-center text-gray-400 text-sm">
          No discharged patients data available
        </div>
      </div>
    );
  }
...
export default DischargedPatientsChart;
