...
const Hospital_Admin_Sidebar_Mobile = ({
  openMobileSidebar,
  ...
  return (
    <>
          ...
          <ul>
            <Link to="/hospital-admin-home-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-home-dashboard"
                ...
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-home-dashboard"
                        ? "fill-white"
                        : ""
                        }`}
                    >
            ...
            <Link to="/hospital-admin-staff-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-staff-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-staff-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-admin-patients-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-patients-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-patients-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
                ...
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-messages-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-admin-appointments-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-appointments-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-appointments-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
                      <path
                        ...
                        className={`group-hover:fill-white ${currentPath ===
                          "/hospital-admin-appointments-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                          }`}
                      />
            ...
            <Link to=""
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-wallet-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-wallet-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to="/hospital-admin-settings-dashboard"
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-settings-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
                  <span>
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${currentPath === "/hospital-admin-settings-dashboard"
                        ? "fill-white"
                        : "fill-[#647284]"
                        }`}
                    >
            ...
            <Link to=""
              ...
              <div className="px-4 my-4">
                <li
                  className={`group px-4 py-2   ${currentPath === "/hospital-admin-subscriptions-dashboard"
                    ? "bg-[#3E4095] text-white"
                    : "text-gray-700"
                    } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                >
      ...
      <div
        className={`fixed inset-0 z-40 transition-opacity duration-300  ${openMobileSidebar
