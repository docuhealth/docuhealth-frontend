...
const Hospital_Admin_Sidebar_Mobile = ({ openMobileSidebar, setOpenMobileSidebar }) => {
    ...
    <>
      ...
      <div
        className={`fixed inset-0 z-40 transition-opacity duration-300 lg:hidden ${
          openMobileSidebar ? "opacity-60 pointer-events-auto" : "opacity-0 pointer-events-none"
        } bg-black`}
      ...
      >
        ...
        <div className="p-4 flex justify-between items-center">
          <div className="flex justify-start items-center gap-2 font-semibold text-docuhealth-primary">
            <img 
              src={profile?.theme?.profile_image} 
              alt="Logo"  
              className="w-6 h-6 aspect-square object-cover rounded-md" 
            />
            <h1 className="text-xl truncate max-w-[160px]">{profile?.name || "DocuHealth"}</h1>
          </div>
          <div className="lg:hidden cursor-pointer" onClick={() => setOpenMobileSidebar(false)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.9994 15L9 9M9.00064 15L15 9" stroke="var(--color-docuhealth-dark)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12Z" stroke="var(--color-docuhealth-dark)" strokeWidth="1.5" />
            </svg>
          </div>
        </div>

        {/* Scrollable Navigation Main Links */}
        <nav className="flex-1 text-sm overflow-y-auto ">
          <ul>
            {/* Overview */}
            <Link to="/hospital-admin-home-dashboard" onClick={() => setOpenMobileSidebar(false)}>
              <div className="px-4 my-4">
                <li className={`group px-4 py-2 ${currentPath === "/hospital-admin-home-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start transition-colors duration-150`}>
                  <span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2.5 10C2.5 10.4602 2.8731 10.8333 3.33333 10.8333H8.33333C8.79358 10.8333 9.16667 10.4602 9.16667 10V3.33333C9.16667 2.8731 8.79358 2.5 8.33333 2.5H3.33333C2.8731 2.5 2.5 2.8731 2.5 3.33333V10ZM2.5 16.6667C2.5 17.1269 2.8731 17.5 3.33333 17.5H8.33333C8.79358 17.5 9.16667 17.1269 9.16667 16.6667V13.3333C9.16667 12.8731 8.79358 12.5 8.33333 12.5H3.33333C2.8731 12.5 2.5 12.8731 2.5 13.3333V16.6667ZM10.8333 16.6667C10.8333 17.1269 11.2064 17.5 11.6667 17.5H16.6667C17.1269 17.5 17.5 17.1269 17.5 16.6667V10C17.5 9.53975 17.1269 9.16667 16.6667 9.16667H11.6667C11.2064 9.16667 10.8333 9.53975 10.8333 10V16.6667ZM11.6667 2.5C11.2064 2.5 10.8333 2.8731 10.8333 3.33333V6.66667C10.8333 7.1269 11.2064 7.5 11.6667 7.5H16.6667C17.1269 7.5 17.5 7.1269 17.5 6.66667V3.33333C17.5 2.8731 17.1269 2.5 16.6667 2.5H11.6667Z" className={`group-hover:fill-white ${currentPath === "/hospital-admin-home-dashboard" ? "fill-white" : "fill-docuhealth-secondary"}`} />
                    </svg>
                  </span>
                  Overview
                </li>
            ...
            {/* Patient Management */}
            <Link to="/hospital-admin-patients-dashboard" onClick={() => setOpenMobileSidebar(false)}>
              <div className="px-4 my-4">
                <li className={`group px-4 py-2 ${currentPath === "/hospital-admin-patients-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start transition-colors duration-150`}>
                  <span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.5 3.33268H4.16667V16.666H15.8333V6.66602H12.5V3.33268ZM2.5 2.49252C2.5 2.03606 2.87291 1.66602 3.33208 1.66602H13.3333L17.4998 5.83268L17.5 17.4931C17.5 17.9568 17.1292 18.3327 16.6722 18.3327H3.32783C2.87063 18.3327 2.5 17.9533 2.5 17.5062V2.49252ZM10 9.58268C8.84942 9.58268 7.91667 8.64993 7.91667 7.49935C7.91667 6.34876 8.84942 5.41602 10 5.41602C11.1506 5.41602 12.0833 6.34876 12.0833 7.49935C12.0833 8.64993 11.1506 9.58268 10 9.58268ZM6.27288 14.166C6.48016 12.291 8.06977 10.8327 10 10.8327C11.9303 10.8327 13.5198 12.291 13.7271 14.166H6.27288Z" className={`group-hover:fill-white ${currentPath === "/hospital-admin-patients-dashboard" ? "fill-white" : "fill-docuhealth-secondary"}`} />
                    </svg>
                  </span>
                  Patient Mgt.
                </li>
            ...
            {/* Ward Management */}
            <Link to="/hospital-admin-ward-management-dashboard" onClick={() => setOpenMobileSidebar(false)}>
              <div className="px-4 my-4">
                <li className={`group px-4 py-2 ${currentPath === "/hospital-admin-ward-management-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start transition-colors duration-150`}>
                  <span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2 20V5H4V16H11V7H20C21.1046 7 22 7.89543 22 9V20H20V18H4V20H2ZM6 12C7.10457 12 8 11.1046 8 10C8 8.89543 7.10457 8 6 8C4.89543 8 4 8.89543 4 10C4 11.1046 4.89543 12 6 12Z" className={`group-hover:fill-white ${currentPath === "/hospital-admin-ward-management-dashboard" ? "fill-white" : "fill-docuhealth-secondary"}`} />
                    </svg>
                  </span>
                  Ward Mgt.
                </li>
            ...
            >
              <div className="px-4 my-4">
                <li className={`group px-4 py-2 ${currentPath === "/hospital-admin-messages-dashboard" ? "bg-docuhealth-primary text-white" : "text-gray-700"} hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start transition-colors duration-150`}>
                  <span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.66797 7.49478C1.66797 4.73624 3.89842 2.5 6.66852 2.5H13.3341C16.0958 2.5 18.3346 4.74565 18.3346 7.49478V17.5H6.66852C3.90679 17.5 1.66797 15.2543 1.66797 12.5052V7.49478ZM16.668 15.8333V7.49478C16.668 5.66283 15.1721 4.16667 13.3341 4.16667H6.66852C4.82179 4.16667 3.33464 5.65382 3.33464 7.49478V12.5052C3.33464 14.3372 4.83057 15.8333 6.66852 15.8333H16.668ZM11.668 9.16667H13.3346V10.8333H11.668V9.16667ZM6.66797 9.16667H8.33464V10.8333H6.66797V9.16667Z" className={`group-hover:fill-white ${currentPath === "/hospital-admin-messages-dashboard" ? "fill-white" : "fill-docuhealth-secondary"}`} />
                    </svg>
                  </span>
                  Messages
                </li>
...
export default Hospital_Admin_Sidebar_Mobile;