    ...
    <>
      ...
      >
        ...
        <nav className="mt-4 text-sm">
          <ul>
            <Link
              to="/hospital-admin-home-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
            ...
            <Link
              to="/hospital-admin-staff-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
            ...
            <Link
              to="/hospital-admin-patients-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
            ...
            <Link
              to="/hospital-admin-ward-management-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
                ...
                >
                  <span>
                    <svg
                      ...
                      className={`group-hover:fill-white ${
                        currentPath ===
                        "/hospital-admin-ward-management-dashboard"
                          ? "fill-white"
                          : "fill-[#647284]"
                      }`}
                    >
            ...
            <Link
              to="/hospital-admin-appointments-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
            ...
            <Link
              to="/hospital-admin-settings-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
