...
import { HosAdmittedPatientMGTContext } from "../../../../../context/HospitalContext/Admin/HosAdmittedPatientMGTContext";
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 lg:p-6 max-w-md w-full relative text-sm">
              ...
              <div className="border rounded-md my-3 p-3 text-[13px] space-y-2">
                <p>
                  ...
                  {selectedPatient?.patient_info?.firstname &&
                  selectedPatient?.patient_info?.lastname
        ...
        {processedAdmittedPatients.map((admittedPatient, index) => (
          <div key={index} className="border p-3 rounded-xl">
            <div className="flex justify-between items-center">
              ...
              <div className="bg-docuhealth-light-green px-2 rounded-full">
                <p className="text-docuhealth-green ">
                  {formatRecordDate(admittedPatient.discharge_date || admittedPatient.closed_at) || 'NIL'}
                </p>
              </div>
            </div>
            <div className="border-b py-2">
            ...
            <div className="flex items-center gap-1 text-gray-600 pt-3">
              ...
              <p className="">
                ...
                {admittedPatient?.discharged_by
                  ? `${admittedPatient.discharged_by.firstname} ${admittedPatient.discharged_by.lastname}`
                  : "NIL"}
              </p>
            </div>
            <div className="flex items-center gap-1 text-gray-600 pt-1 ">
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 text-sm px-3">
              <div className="bg-white rounded-lg shadow-lg p-4 lg:p-6 max-w-md w-full relative text-sm">
                ...
                <div className="border rounded-md my-3 p-3 text-[13px] space-y-2">
                  ...
                  <p>
                    <strong>Date of Discharge:</strong>{" "}
                    {formatFullDateTime(selectedPatient.discharge_date || selectedPatient.closed_at) || "NIL"}
                  </p>
                </div>
              </div>
            </div>
        ...
        <>
                    ...
                    <div className="my-4 text-[12px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {sortedOutPatients.map((outPatient, index) => (
                            <div key={index} className="border p-4 rounded-lg">
                                ...
                                <button
                                    className="text-center mt-3 py-2 border border-docuhealth-dark w-full rounded-full cursor-pointer"
                                    onClick={() => setSelectedPatient(outPatient)}
                                >
                                    View patient's details
                                </button>
                            </div>
            ...
            {selectedPatient && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 text-sm px-3">
                    <div className="bg-white rounded-lg shadow-lg p-4 lg:p-6 max-w-md w-full relative text-sm">
                        <div className='flex justify-end'>
                            <button onClick={() => setSelectedPatient(null)} className="text-gray-500 hover:text-black">
                                <i className="bx bx-x text-2xl cursor-pointer"></i>
                            </button>
                        </div>
                        <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="border rounded-md my-3 p-3 text-[13px] space-y-2">
                            <p><strong>Name:</strong> {selectedPatient?.patient_info?.firstname} {selectedPatient?.patient_info?.lastname}</p>
...
const DischargedPatientsWrapper = () => {
...
const tabs = [
  {
    ...
    status: "inpatient",
    content: <AdmittedPatientsTab />,
  },
  {
    title: "Out Patients",
    status: "outpatient",
    content: <OutPatientsTab />,
  },
  {
