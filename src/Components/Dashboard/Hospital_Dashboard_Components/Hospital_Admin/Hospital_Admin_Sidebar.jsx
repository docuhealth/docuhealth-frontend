                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-home-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-patients-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-ward-management-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-messages-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-appointments-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-wallet-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-subscriptions-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-settings-dashboard" ? "fill-white" : "fill-[#647284]"
                      }`}
                    />
                  </svg>
                </span>
