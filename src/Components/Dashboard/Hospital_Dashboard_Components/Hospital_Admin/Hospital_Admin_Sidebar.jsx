        ...
        <ul>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-home-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-patients-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
          ...
          <Link to="/hospital-admin-ward-management-dashboard">
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
                  currentPath === "/hospital-admin-ward-management-dashboard"
                    ? "bg-docuhealth-primary text-white"
                    : "text-gray-700"
                } hover:bg-docuhealth-primary hover:text-white rounded-lg flex items-center gap-2 justify-start`}
              >
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-ward-management-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
          ...
          {/* Messages */}
          <Link to="" onClick={() => toast.success('Feature is coming soon')}>
            <div className="px-4 my-4">
              <li
                className={`group px-4 py-2 ${
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-messages-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-appointments-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-wallet-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-subscriptions-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      className={`group-hover:fill-white ${
                        currentPath === "/hospital-admin-settings-dashboard" ? "fill-white" : "fill-docuhealth-secondary"
                      }`}
                    />
                  </svg>
                </span>
