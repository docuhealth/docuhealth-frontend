      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <FormField label="Plan title">
          <input
            ...
            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary"
        ...
        <FormField label="Plan Price">
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-md pl-8 pr-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary"
              placeholder="0"
            />
          </div>
        </FormField>
        ...
        <FormField label="Description">
          <textarea
            ...
            rows={2}
            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary resize-none"
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            className="px-5 py-2 rounded-full bg-docuhealth-primary text-white text-sm font-semibold hover:bg-docuhealth-dark-primary transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isCreating && (
        ...
        <FormField label="Plan title">
          <div className="relative">
            <input
              ...
              value={form.name}
              onChange={(e) => handleChange("name", e.target.value)}
              className="w-full border border-gray-300 rounded-md px-3 py-2 pr-9 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary"
            />
            <PencilIcon />
          </div>
        </FormField>
        ...
        <FormField label="Plan Price">
          <div className="relative">
            ...
            <input
              ...
              value={form.price}
              onChange={(e) => handleChange("price", e.target.value)}
              className="w-full border border-gray-300 rounded-md pl-8 pr-9 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary"
            />
            <PencilIcon />
          </div>
        </FormField>
...
const SelectField = ({ id, value, onChange, options, capitalize }) => (
  <div className="relative">
    <select
      ...
      value={value}
      onChange={onChange}
      className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary appearance-none bg-white pr-8"
    >
      {options.map((opt) => (
  ...
  <div>
    ...
    {features.length < MAX_FEATURES && (
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 border border-gray-200 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-docuhealth-primary focus:border-docuhealth-primary"
        />
        <button
          type="button"
          onClick={onAdd}
          className="text-docuhealth-primary font-semibold text-sm hover:underline whitespace-nowrap"
        >
          + Add
        </button>
      </div>
    ...
    {features.length === 0 && (
      <button
        ...
        className="text-docuhealth-primary text-sm font-semibold"
      >
        + Add new feature
      </button>
    )}
...
const PencilIcon = () => (
  <svg
    className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-docuhealth-primary pointer-events-none"
    fill="none" viewBox="0 0 24 24" stroke="currentColor"
  >
