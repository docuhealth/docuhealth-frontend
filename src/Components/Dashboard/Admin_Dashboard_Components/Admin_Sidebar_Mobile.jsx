      ...
      >
        ...
        >
          <div className="px-4 my-4">
            <li
              className={`group px-4 py-2   ${currentPath === "/admin-home-dashboard"
            ...
            >
              <span>
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`group-hover:fill-white ${currentPath === "/admin-home-dashboard"
                    ? "fill-white"
                    : ""
                    }`}
                >
        ...
        >
          <div className="px-4 my-4">
            <li
              className={`group px-4 py-2   ${currentPath === "/admin-users-dashboard"
                ? "bg-[#3E4095] text-white"
                : "text-gray-700"
                } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
            >
              ...
              <span>
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`group-hover:fill-white ${currentPath === "/admin-users-dashboard"
                    ? "fill-white"
                    : "fill-[#647284]"
                    }`}
                >
        ...
        <Link to="/admin-subscriptions-dashboard"
        onClick={() => setOpenMobileSidebar(false)}
        >
          <div className="px-4 my-4">
            <li
              className={`group px-4 py-2   ${currentPath === "/admin-subscriptions-dashboard"
                ? "bg-[#3E4095] text-white"
                : "text-gray-700"
                } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
            >
              <span>
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`group-hover:fill-white ${currentPath === "/admin-subscriptions-dashboard"
                    ? "fill-white"
                    : "fill-[#647284]"
                    }`}
                >
        ...
        <Link to="/admin-settings-dashboard"
        onClick={() => setOpenMobileSidebar(false)}
        >
          <div className="px-4 my-4">
            <li
              className={`group px-4 py-2   ${currentPath === "/admin-settings-dashboard"
                ? "bg-[#3E4095] text-white"
                : "text-gray-700"
                } text-gray-700 hover:bg-[#3E4095] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
            >
              <span>
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`group-hover:fill-white ${currentPath === "/admin-settings-dashboard"
                    ? "fill-white"
                    : "fill-[#647284]"
                    }`}
                >
