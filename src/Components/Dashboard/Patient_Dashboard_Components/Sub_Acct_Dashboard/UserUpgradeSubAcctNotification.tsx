interface UserUpgradeSubAcctNotificationProps {
    subAcctUpgradeSuccessNot: boolean;
    setSubAcctUpgradeSuccessNot: (value: boolean) => void;
}

const UserUpgradeSubAcctNotification = ({ subAcctUpgradeSuccessNot, setSubAcctUpgradeSuccessNot }: UserUpgradeSubAcctNotificationProps) => {
    return (
        <>
            <div>
                {
