...
interface MedicalRecordsDetailProps {
    ...
    <>
      <div className="bg-white my-5 border rounded-lg py-5 px-5  text-sm">
        ...
        <div className="p-5 my-5 bg-docuhealth-light-gray border rounded-lg">
          ...
          <div>
            {(selectedMedicalRecord?.investigation_docs?.length ?? 0) > 0 ? (
        ...
        <div className="p-5 my-5 bg-docuhealth-light-gray border rounded-lg">
          ...
          <div className="text-[12px] text-gray-700">
            {(selectedMedicalRecord?.care_instructions?.length ?? 0) > 0 ? (
        ...
        <div className="p-5 my-5 bg-docuhealth-light-gray border rounded-lg">
          ...
          <div className="text-[12px] text-gray-700">
            {(selectedMedicalRecord?.treatment_plan?.length ?? 0) > 0 ? (
              <ul className="list-disc pl-5 space-y-1">
