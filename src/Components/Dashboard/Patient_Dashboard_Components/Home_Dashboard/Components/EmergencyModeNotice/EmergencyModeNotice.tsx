...
interface EmergencyModeNoticeProps {
  emergencyStatusModal: boolean;
  setEmergencyStatusModal: (value: boolean) => void;
  handleEmergencyStatusModal: () => void;
}

const EmergencyModeNotice = ({emergencyStatusModal, setEmergencyStatusModal, handleEmergencyStatusModal}: EmergencyModeNoticeProps) => {
