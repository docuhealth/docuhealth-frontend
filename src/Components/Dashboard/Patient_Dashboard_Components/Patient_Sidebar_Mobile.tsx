...
interface Patient_Sidebar_MobileProps {
...
const Patient_Sidebar_Mobile = ({
  ...
  return (
    <>
      ...
      />
      <div
        className={`w-64 h-screen absolute top-0 left-0 z-50 bg-white transform transition-transform duration-300 ease-in-out flex flex-col
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto text-sm">
          <ul>
            ...
            <Link
              to="/user-subscriptions-dashboard"
              onClick={() => setOpenMobileSidebar(false)}
            >
              <div className="px-4 my-4">
                <li
        ...
        <div className="shrink-0">
          ...
          <div className="text-sm border-t border-gray-100 pb-4 pt-2">
            <ul>
...
export default Patient_Sidebar_Mobile;
