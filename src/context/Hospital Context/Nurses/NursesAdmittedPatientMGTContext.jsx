...
const NursesAdmittedPatientMGTProvider = (props) => {
    ...
    useEffect(() => {
        ...
        return (
            <NursesAdmittedPatientMGTContext.Provider value ={{admittedPatients, setAdmittedPatients, loading, count, currentPage, totalPages, fetchAdmittedPatients, tab, setTab}}>
                {props.children}
