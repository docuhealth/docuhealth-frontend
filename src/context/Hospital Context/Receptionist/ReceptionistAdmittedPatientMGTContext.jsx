...
const ReceptionistAdmittedPatientMGTProvider = (props) => {
    ...
    return (
        <ReceptionistAdmittedPatientMGTContext.Provider value ={{admittedPatients, setAdmittedPatients, loading, count, currentPage, totalPages, fetchAdmittedPatients, tab, setTab}}>
            {props.children}
