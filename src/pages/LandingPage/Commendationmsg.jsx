...
const Commendationmsg = () => {
    ...
    <div className="mx-5 lg:mx-28 my-10">
      <div className="flex flex-col justify-start items-start ">
        ...
        <div className="">
          ...
          <div className="hidden sm:block bg-white shadow-sm py-10 px-5">
          ...
          <div class="relative p-4 bg-white shadow-sm rounded-lg overflow-hidden sm:hidden">
  ...
  <div class="absolute bottom-0 left-0 w-full h-16 bg-linear-to-t from-white to-transparent pointer-events-none"></div>
</div>
