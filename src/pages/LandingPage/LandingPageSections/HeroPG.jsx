  ...
  return (
    <div className="min-h-screen lg:min-h-screen flex flex-col justify-center items-center py-28 sm:py-28 px-5">
      <div className="relative sm:p-10  flex flex-col justify-center items-center">
        ...
        <div
          className="bg-[#F6FDFF]  flex justify-center items-center gap-1 py-2 px-3 sm:px-5 rounded-full mb-3 text-center "
          data-aos="zoom-in-up"
        >
          <div>
            <svg
        ...
        <div>
          <div
            className=" text-2xl md:text-5xl text-center font-bold text-[#8E8EA9]"
            data-aos="zoom-in-up"
          >
          ...
          <div>
            <p
              className="text-[#8E8EA9] text-sm sm:text-base text-center py-4"
              data-aos="fade-up"
            >
          ...
          <div
            className="flex justify-center items-center py-5 w-full"
            data-aos="fade-right"
          >
            <div className="bg-[#3535FE]  transition-all hover:bg-[#2626BD] py-2 px-5 rounded-full w-full sm:w-auto">
              <Link to="/user-create-account" className="w-full">
                <button className="text-white w-full  flex justify-center items-center gap-1">
      ...
      <div
        className="bg-gradient-to-b from-[#CAD1FF] to-[#869799] p-2 sm:p-5 rounded-lg lg:rounded-3xl my-3"
        data-aos="zoom-in"
      >
