...
const APPOINTMENT_ROUTES = [
  "/hospital-lab-appointments-dashboard",
  "/hospital-lab-appointment-detail",
];
...
const Hospital_Lab_Layout = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      activePaths: TEST_ORDERS_ROUTES,
      icon: (isActive) => (
        <svg
          width="20"
          height="20"
    ...
    },
    {
      ...
      activePaths: APPOINTMENT_ROUTES,
      icon: (isActive) => (
        <svg
          width="20"
          height="20"
