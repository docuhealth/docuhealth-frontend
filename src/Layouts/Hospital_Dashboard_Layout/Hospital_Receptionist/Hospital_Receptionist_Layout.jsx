...
const Hospital_Receptionist_Layout = () => {
  ...
  const navItems = [
    {
      ...
      icon: (isActive) => (
        <svg
          ...
          className={`group-hover:fill-white ${isActive ? "fill-white" : ""}`}
        >
          <path
...

    {
      ...
      icon: (isActive) => (
        ...
        >
          <path
            d="M17.5062 2.5C17.9627 2.5 18.3327 2.87079 18.3327 3.32783V16.6722C18.3327 17.1293 17.9533 17.5 17.5062 17.5H2.49252C2.03606 17.5 1.66602 17.1292 1.66602 16.6722V3.32783C1.66602 2.87063 2.04544 2.5 2.49252 2.5H17.5062ZM16.666 4.16667H3.33268V15.8333H16.666V4.16667ZM14.9993 12.5V14.1667H4.99935V12.5H14.9993ZM9.99935 5.83333V10.8333H4.99935V5.83333H9.99935ZM14.9993 9.16667V10.8333H11.666V9.16667H14.9993ZM8.33268 7.5H6.66602V9.16667H8.33268V7.5ZM14.9993 5.83333V7.5H11.666V5.83333H14.9993Z"
            className={`group-hover:fill-white ${isActive ? "fill-white" : "fill-docuhealth-secondary"}`}
          />
        </svg>
      ),
  ...
  return (
    <DashboardLayout
      ...
      roleLabel="Hospital Receptionist"
      navItems={navItems}
