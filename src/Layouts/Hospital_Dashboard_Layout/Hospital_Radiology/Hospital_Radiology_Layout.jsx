...
const SCAN_ORDERS_ROUTES = [
  "/hospital-radiology-requests-dashboard",
  "/hospital-radiology-scan-detail",
  "/hospital-radiology-upload-result",
];
...
const Hospital_Radiology_Layout = () => {
  ...
  // "Overview", "Scan Orders", "Appointments", "Health Personnel" and
  // "Settings" are wired up so far — "Messages" is still a "Coming Soon"
  // stub (same pattern Hospital_Lab_Layout uses) so the sidebar reads like
  // a finished department shell rather than a half-built one.
  const navItems = [
    {
      name: "Overview",
    ...
    },
    {
      ...
      activePaths: SCAN_ORDERS_ROUTES,
      icon: (isActive) => (
        <svg
          width="20"
          height="20"
...
export default Hospital_Radiology_Layout;
