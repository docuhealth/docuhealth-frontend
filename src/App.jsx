...
import ALP from "./Admin Login PG/ALP";
import ACA from "./Admin Create Acct/ACA";
import AFP from "./Admin Forgot Password/AFP";
import AVO from './Admin Verify OTP/AVO'
import ASNW from "./Admin Set New Password/ASNW";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        />
        <Route
          path="/hospital-patients-dashboard"
          element={
            <ProtectedRouteHospital>
              <PatientsDashboard />
            </ProtectedRouteHospital>
        ...
        />
        <Route
          path="/hospital-settings-dashboard"
          element={
            <ProtectedRouteHospital>
              <SettingsDashboard />
            </ProtectedRouteHospital>
        ...
        />
        <Route
          path="/hospital-subscriptions-dashboard"
          element={
            <ProtectedRouteHospital>
        ...
        />
        <Route
          path="/hospital-logout-dashboard"
          element={
            <ProtectedRouteHospital>
              <LogOutDashboard />
            </ProtectedRouteHospital>
        ...
        <Route path="/admin-create-account" element={<ACA />} />
        <Route path="/admin-login" element={<ALP />} />
        <Route path="/admin-forgot-password" element={<AFP />} />
        <Route path="/admin-verify-otp" element={<AVO />} />
        <Route path="/admin-set-new-password" element={<ASNW />} />

        <Route path="/admin-home-dashboard" element={
          <AdminProtectedRoute>
          <AdminHomeDashboard />
          </AdminProtectedRoute>} />
