...
const AdminLogoutDashboard = () => {
  ...
  const location = useLocation();
    ...
    const isActive = (path = '/admin-home-dashboard') => location.pathname === path;
      ...
      const handleLogOut = async () => {
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            localStorage.removeItem("adminlogin"); // Remove login data
    ...
    <div>
      ...
      <aside
              ...
              >
                ...
                <nav className="mt-4">
                  <ul>
                    ...
                    <Link
                      to="/admin-subscriptions-dashboard"
                      onClick={closeSidebar}
                    >
                      <div className="px-4 my-4">
                        <li className={`group px-4 py-2   ${
        ...
        <main className="flex-1">
          {/* Header */}
         <AdminHead  isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} closeSidebar= {closeSidebar} />
...
export default AdminLogoutDashboard
