          ...
          {activeTab === "plans" ? (
            <>
              <button
                ...
                className="flex justify-center items-center gap-2 px-5 py-2 border border-docuhealth-primary text-docuhealth-primary font-medium rounded-full hover:bg-blue-50 transition w-full sm:w-auto text-sm"
              >
                Create a new plan
              </button>
              <button
                ...
                className="flex justify-center items-center gap-2 px-5 py-2 bg-docuhealth-primary text-white font-medium rounded-full hover:bg-docuhealth-dark-primary transition w-full sm:w-auto text-sm"
              >
                    ...
                    {ROLE_OPTIONS.map((opt) => (
                      <button
                        ...
                        className={`block w-full text-left px-4 py-2 text-sm transition-colors hover:bg-blue-50 ${
                          subscribedUsersRole === opt.value ? "text-docuhealth-primary font-semibold" : "text-gray-700"
                        }`}
                      >
                        {opt.label}
                      </button>
