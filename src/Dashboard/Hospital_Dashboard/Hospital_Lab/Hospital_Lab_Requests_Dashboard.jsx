...
const allOrders = [
  ...
  },
  {
    ...
    datetime: "30th, May., 2026/ 10:20 AM",
    badge: "New",
    badgeType: "new",
    tab: "Pending Test",
  },
  {
    ...
    hospital: "Lagos General Hospital",
    datetime: "29th, May., 2026/ 8:30 AM",
    badge: "1 day ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    datetime: "29th, May., 2026/ 11:15 AM",
    badge: "1 day ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    hospital: "Eko Hospital",
    datetime: "28th, May., 2026/ 4:45 PM",
    badge: "2 days ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    test: "Widal Test",
    hospital: "Lagos General Hospital",
    datetime: "27th, May., 2026/ 10:00 AM",
    badge: "3 days ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    hospital: "Eko Hospital",
    datetime: "26th, May., 2026/ 12:00 PM",
    badge: "4 days ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    name: "Zainab Sule",
    hin: "39012*************",
    test: "Electrolytes & Urea",
    hospital: "St. Nicholas Hospital",
    datetime: "25th, May., 2026/ 10:45 AM",
    badge: "5 days ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  {
    ...
    test: "Urinalysis",
    hospital: "Lagos General Hospital",
    datetime: "24th, May., 2026/ 8:00 AM",
    badge: "1 week ago",
    badgeType: "old",
    tab: "Pending Test",
  },
  ...
  /* In-progress */
  {
    ...
    test: "Malaria RDT",
    hospital: "Eko Hospital",
    datetime: "30th, May., 2026/ 2:00 PM",
    badge: "Doctor request",
    badgeType: "request",
    tab: "In-progress",
  },
  {
    ...
    test: "Hepatitis B Screen",
    hospital: "Lagos General Hospital",
    datetime: "29th, May., 2026/ 3:30 PM",
    badge: "Appointment",
    badgeType: "appt",
    tab: "In-progress",
  },
  {
    ...
    test: "Full Blood Count",
    hospital: "St. Nicholas Hospital",
    datetime: "28th, May., 2026/ 11:45 AM",
    badge: "Doctor request",
    badgeType: "request",
    tab: "In-progress",
  },
  {
    ...
    hospital: "Eko Hospital",
    datetime: "27th, May., 2026/ 4:00 PM",
    badge: "Appointment",
    badgeType: "appt",
    tab: "In-progress",
  },
  {
    ...
    test: "Urinalysis",
    hospital: "Lagos General Hospital",
    datetime: "27th, May., 2026/ 9:00 AM",
    badge: "Appointment",
    badgeType: "appt",
    tab: "In-progress",
  },
  {
    ...
    test: "Thyroid Function Test",
    hospital: "Eko Hospital",
    datetime: "26th, May., 2026/ 4:45 PM",
    badge: "Doctor request",
    badgeType: "request",
    tab: "In-progress",
  },
  ...
  },
  {
    ...
    test: "Electrolytes & Urea",
    hospital: "St. Nicholas Hospital",
    datetime: "26th, May., 2026/ 1:30 PM",
    badge: "Completed",
    badgeType: "completed",
    tab: "Completed test",
  },
  {
    ...
    test: "Malaria/Typhoid Test",
    hospital: "Eko Hospital",
    datetime: "25th, May., 2026/ 9:30 AM",
    badge: "Completed",
    badgeType: "completed",
    tab: "Completed test",
  },
  {
    ...
    test: "Urinalysis",
    hospital: "Lagos General Hospital",
    datetime: "23rd, May., 2026/ 8:15 AM",
    badge: "Completed",
    badgeType: "completed",
    tab: "Completed test",
  },
  {
    ...
    test: "Widal Test",
    hospital: "Lagos General Hospital",
    datetime: "24th, May., 2026/ 10:00 AM",
    badge: "Completed",
    badgeType: "completed",
    tab: "Completed test",
  },
  {
    ...
    test: "Hepatitis B Screen",
    hospital: "Eko Hospital",
    datetime: "23rd, May., 2026/ 12:00 PM",
    badge: "Completed",
    badgeType: "completed",
    tab: "Completed test",
  },
  ...
  /* Rejected */
  {
    ...
    test: "Blood Culture",
    hospital: "St. Nicholas Hospital",
    datetime: "29th, May., 2026/ 1:00 PM",
    badge: "Rejected",
    badgeType: "rejected",
    tab: "Rejected test",
  },
  {
    ...
    test: "Sputum Culture",
    hospital: "Eko Hospital",
    datetime: "26th, May., 2026/ 2:15 PM",
    badge: "Rejected",
    badgeType: "rejected",
    tab: "Rejected test",
  },
  ...
  },
  {
    ...
    test: "Full Blood Count",
    hospital: "Lagos General Hospital",
    datetime: "24th, May., 2026/ 11:45 AM",
    badge: "Rejected",
    badgeType: "rejected",
    tab: "Rejected test",
  },
  {
    ...
    test: "Liver Function Test",
    hospital: "Eko Hospital",
    datetime: "23rd, May., 2026/ 8:30 AM",
    badge: "Rejected",
    badgeType: "rejected",
    tab: "Rejected test",
  },
  {
    ...
    test: "Blood Glucose",
    hospital: "St. Nicholas Hospital",
    datetime: "22nd, May., 2026/ 11:15 AM",
    badge: "Rejected",
    badgeType: "rejected",
    tab: "Rejected test",
  },
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span
                    className={`text-[10px] font-semibold px-2 py-1 rounded-full whitespace-nowrap shrink-0 ${
                      order.badgeType === "new" ||
                      order.badgeType === "completed"
                        ? "bg-green-100 text-green-600"
                        : order.badgeType === "request" ||
                            order.badgeType === "appt"
