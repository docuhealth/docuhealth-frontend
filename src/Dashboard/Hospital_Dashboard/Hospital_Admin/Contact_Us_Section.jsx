...
const Contact_Us_Section = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (activeTab === "provider") {
      // Format for provider
      payload = {
        redirect_url: "https://docuhealthservices.net/hospital-verification-request", // or dynamically set this if needed
        name: formData.name,
  ...
  return (
    <BackgroundTemplate>
      <section
        className="py-24 px-5 lg:px-16 text-sm text-docuhealth-gray bg-docuhealth-light-blue lg:bg-white overflow-hidden"
        id="contact-us"
      >
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                <div className="bg-docuhealth-light-blue p-3 rounded-lg border">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <form onSubmit={handleSubmit} className="space-y-5 2xl:text-lg">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-docuhealth-primary outline-hidden "
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-docuhealth-primary text-white py-3 rounded-full hover:bg-blue-900 transition-colors"
                >
                  Send message
                </button>
              </form>
            ...
            {activeTab === "provider" && (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <p className="text-xs text-gray-500 -mt-2">
                  By messaging us, you agree to our <Link to="/terms-and-conditions" className="text-docuhealth-primary underline font-medium">Terms and Conditions</Link> for Hospitals.
                </p>
                ...
                <button
                  ...
                  className={`w-full    ${
                loading
                  ? "bg-gray-400 cursor-not-allowed"  : "bg-docuhealth-primary hover:bg-blue-900  cursor-pointer"  
