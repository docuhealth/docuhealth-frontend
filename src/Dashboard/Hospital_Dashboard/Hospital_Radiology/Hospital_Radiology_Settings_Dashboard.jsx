...
import Settings from "../../../Components/Dashboard/Hospital_Dashboard_Components/Hospital_Radiology/Settings_Dashboard/Settings";
import { RadiologyAppContext } from "../../../context/HospitalContext/Radiology/RadiologyAppContext";

const Hospital_Radiology_Settings_Dashboard = () => {
 const {profile} = useContext(RadiologyAppContext)
...
export default Hospital_Radiology_Settings_Dashboard;
