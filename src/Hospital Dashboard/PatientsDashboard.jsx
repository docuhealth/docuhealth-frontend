...
const PatientsDashboard = () => {
  ...
  const handleDownloadPDF = () => {
    const doc = new jsPDF();
    doc.text("Recent Patients Attended To", 14, 10);
  ...
  return (
    <div>
      <div className="min-h-screen bg-gray-100 flex">
        ...
        <aside
          className={`fixed top-0 left-0 min-h-screen w-60 bg-white shadow-lg border z-20 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
            ...
            <ul>
              <Link to="/hospital-home-dashboard" onClick={closeSidebar}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2   ${isActive("/hospital-home-dashboard")
                  ...
                  >
                    <span>
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                        id="svg"
                        className={`group-hover:fill-white ${isActive("/hospital-home-dashboard")
                            ? "fill-white"
                            : ""
                          }`}
                      >
              ...
              <Link to="/hospital-patients-dashboard" onClick={closeSidebar}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2   ${isActive("/hospital-patients-dashboard")
                        ? "bg-[#0000FF] text-white"
                        : "text-gray-700"
                      } text-gray-700 hover:bg-[#0000FF] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                  >
                    <span>
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className={`group-hover:fill-white ${isActive("/hospital-patients-dashboard")
                            ? "fill-white"
                            : "fill-[#647284]"
                          }`}
                      >
              ...
              <Link to="/hospital-settings-dashboard" onClick={closeSidebar}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2   ${isActive("/hospital-settings-dashboard")
                        ? "bg-[#0000FF] text-white"
                        : "text-gray-700"
                      } text-gray-700 hover:bg-[#0000FF] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                  >
                    <span>
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className={`group-hover:fill-white ${isActive("/hospital-settings-dashboard")
                            ? "fill-white"
                            : "fill-[#647284]"
                          }`}
                      >
                        <g clip-path="url(#clip0_274_2617)">
                          <path
                            ...
                            className={`group-hover:fill-white ${isActive("/user-settings-dashboard")
                                ? "fill-white"
                                : "fill-[#647284]"
                              }`}
                          />
              ...
              >
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2   ${isActive("/hospital-subscriptions-dashboard")
                        ? "bg-[#0000FF] text-white"
                        : "text-gray-700"
                      } text-gray-700 hover:bg-[#0000FF] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                  >
                    <span>
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className={`group-hover:fill-white ${isActive("/hospital-subscriptions-dashboard")
                            ? "fill-white"
                            : "fill-[#647284]"
                          }`}
              ...
              <Link to="/hospital-logout-dashboard" onClick={closeSidebar}>
                <div className="px-4 my-4">
                  <li
                    className={`group px-4 py-2   ${isActive("/hospital-logout-dashboard")
                        ? "bg-[#0000FF] text-white"
                        : "text-gray-700"
                      } text-gray-700 hover:bg-[#0000FF] hover:text-white rounded-lg flex items-center gap-2 justify-start`}
                  >
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`group-hover:fill-white ${isActive("/hospital-logout-dashboard")
                          ? "fill-white"
                          : "fill-[#647284]"
                        }`}
                    >
          ...
          <section className="p-8">
            <div className="flex flex-col md:flex-row justify-start items-start md:justify-between md:items-center gap-3">
              ...
              {patientData ? (
                     <div>
                     <button
                       className="bg-[#0000FF] text-white py-2 px-4 rounded-full"
              ...
              <div>
                <div className="p-6 bg-white rounded-xl shadow-lg my-4">
                  <div className="hidden lg:block">
                    <div className="flex flex-col md:flex-row gap-3 justify-between items-center pb-3">
