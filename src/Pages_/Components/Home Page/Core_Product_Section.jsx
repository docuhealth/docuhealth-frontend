...
const Core_Product_Section = () => {
  ...
  return (
    <>
      <BackgroundTemplate>
        <div className="py-24 px-16 text-sm text-[#464646]">
          <h2 className="font-semibold pb-4 text-3xl text-[#3E4095] text-center">
          ...
          <div className="flex gap-6 text-sm">
            {core_products.map((core_product, index) => {
              ...
              <div key={index} className="p-8 border rounded-2xl flex-1 ">
               ...
               <div className="w-16 h-16 bg-[#3E4095] rounded-full flex items-center justify-center mx-auto mb-4">
