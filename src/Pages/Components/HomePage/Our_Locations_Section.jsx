      ...
      <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto w-full px-8 xl:px-16 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex flex-col items-center justify-between p-8 bg-white border border-dashed border-gray-300 rounded-lg hover:shadow-md transition-all text-center min-h-[250px]"
          >
